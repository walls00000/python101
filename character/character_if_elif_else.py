...
user_reply = raw_input("Do you like robots?  (type yes, no, maybe, or 'only ones with laser eyes')")
...
if user_reply == "yes":
    ...
    print ("ZZZZZZZZZZZZZZZZZZZZZZZZZZZAAAAAAAAAAAAAAAAAAAAAAAPPPPPPPPPPPPPPPPPPPPPP!")
elif user_reply == "no":
